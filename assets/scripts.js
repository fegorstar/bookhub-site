...
catalogSearchBox.addEventListener('input', (e) => {
    ...
    if (searchTerm === "") {
        notFoundMessage.style.display = "none";
        renderBooks(books.slice(0, 8)); // Show initial 8 books by default
        viewMoreBtn.style.display = "block"; // Show view more button by default
    } else {
...
viewMoreBtn.addEventListener('click', () => {
    renderBooks(books);
    viewMoreBtn.style.display = "none"; // Hide after displaying all books
});
